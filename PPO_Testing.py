...
def evaluate_trained_agents(
    ...
    from WarGamingEnvironment_v9 import EnvironmentConfig, MARLMilitaryEnvironment, ForceType, UnitType
    ...
    from PPO_Training import WarGameMARLPPO
...
if __name__ == "__main__":
    ...
    vis_results = visualize_trained_agents_with_logging(
        ...
        model_dir=model_dir,
        map_file="test_map.csv",  # or "training_map_lvl_1.csv" if that's what you have
        objective_location=(73, 75),
        enemy_positions=[
            (73, 80), (73, 71), (78, 75), (66, 75)
        ],
        ...
        max_steps=300,
        output_dir="./visualization_with_logging",
        save_video=True,
