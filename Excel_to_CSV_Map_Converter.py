...
import csv
import os
from WarGamingEnvironment_v12 import TerrainType, ElevationType


def excel_to_csv(excel_file_path: str, csv_file_path: str, max_width: int = 100, max_height: int = 100):  # max_width: 400
...
if __name__ == "__main__":
    ...
    excel_file = os.path.join(script_dir, "training_map_lvl_2.xlsx")  # map_design.xlsx
    csv_file = os.path.join(script_dir, "training_map_lvl_2.csv")  # generated_map.csv
